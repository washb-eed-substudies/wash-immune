...
d <- bind_rows(
  ...
  data.frame(readjustfunc(t2_il17_adj_L), name="IL-17A", age="14"),
  data.frame(readjustfunc(t2_il21_adj_L), name="IL-21", age="14"),
  data.frame(readjustfunc(t2_il10_adj_L), name="IL-10", age="14"),
  data.frame(readjustfunc(t2_gmc_adj_L), name="GM-CSF", age="14"),
  ...
  data.frame(readjustfunc(t3_il17_adj_L), name="IL-17A", age="28"),
  data.frame(readjustfunc(t3_il21_adj_L), name="IL-21", age="28"),
  data.frame(readjustfunc(t3_il10_adj_L), name="IL-10", age="28"),
  data.frame(readjustfunc(t3_gmc_adj_L), name="GM-CSF", age="28"),
  ...
  data.frame(readjustfunc(d23_ln_il17_adj_L), name="IL-17A", age="14-28"),
  ...
  data.frame(readjustfunc(d23_ln_gmc_adj_L), name="GM-CSF", age="14-28"),
