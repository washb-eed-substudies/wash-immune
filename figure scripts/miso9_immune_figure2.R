...
#Load tmle results
load(here::here("results/immune_N_tr_means.RData"))
...
d <- rbind(
  data.frame(readjustfunc(t2_ratio_il1_il10_N_tr), name="Interleukin-1β/Interleukin-10", age=14),
  data.frame(readjustfunc(t3_ratio_il1_il10_N_tr), name="Interleukin-1β/Interleukin-10", age=28),
  ...
  data.frame(readjustfunc(t2_ratio_ifn_il10_N_tr), name="Interferon-γ/Interleukin-10", age=14),
  ...
  data.frame(readjustfunc(t2_ratio_gmc_il10_N_tr), name="Granulocyte-macrophage \n colony-stimulating factor/Interleukin-10", age=14),
  data.frame(readjustfunc(t3_ratio_gmc_il10_N_tr), name="Granulocyte-macrophage \n colony-stimulating factor/Interleukin-10", age=28),
...
ggsave(p, file = here("figures/immune_figure2.tiff"), height = 15, width = 12, dpi=300)
