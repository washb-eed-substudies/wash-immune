...
#d<- read.csv(paste0(dropboxDir,"Data/Cleaned/Audrie/washb-bangladesh-anthro-diar-ee-med-enrol-tracking-immun-ipcw2.csv"), stringsAsFactors = TRUE)
d<-read.csv(paste0(dropboxDir,"Data/Cleaned/Audrie/bangladesh-dm-ee-plasma-lab.csv"), stringsAsFactors = TRUE)
