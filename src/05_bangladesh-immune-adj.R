...
temp_metric_crp <- rbind(temp_metric_crp_n, t3_crp_adj_L, temp_metric_crp_wsh)
...
temp_metric_agp <- rbind(temp_metric_agp_n, t3_agp_adj_L, temp_metric_agp_wsh)
rownames(temp_metric_agp) <- c("Nutrition v C", "Nutrition + WSH v C", "WSH v C")
colnames(temp_metric_agp) <-c("RD","ci.lb","ci.ub","SE","z","P-value")

save(temp_metric_agp, temp_metric_crp, file = here('results/crp_agp_n_wsh/adj_crp_agp_t3.RData'))
