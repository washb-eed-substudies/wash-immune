...
pvaltbl12f <- c( "P-value" ,  as.character(round(t2_ratio_il1_il10_subgroup_L$`P-value`[1], 2)), 
                 as.character(round(t2_ratio_il6_il10_subgroup_L$`P-value`[1], 2)),  
                 as.character(round(t2_ratio_tnf_il10_subgroup_L$`P-value`[1], 2)), 
                 as.character(round(t2_ratio_il12_il10_subgroup_L$`P-value`[1], 2)), 
                 as.character(round(t2_ratio_ifn_il10_subgroup_L$`P-value`[1], 2)), 
                 as.character(round(t2_ratio_il4_il10_subgroup_L$`P-value`[1], 2)), 
                 as.character(round(t2_ratio_il5_il10_subgroup_L$`P-value`[1], 2)),  
                 as.character(round(t2_ratio_il13_il10_subgroup_L$`P-value`[1], 2)), 
                  as.character(round(t2_ratio_il17_il10_subgroup_L$`P-value`[1], 2)),  
                 as.character(round(t2_ratio_il21_il10_subgroup_L$`P-value`[1], 2)),  
                  as.character(round(t2_ratio_il2_il10_subgroup_L$`P-value`[1], 2)),  
                  as.character(round(t2_ratio_gmc_il10_subgroup_L$`P-value`[1], 2)),  
                  as.character(round(t2_ratio_il12_il4_subgroup_L$`P-value`[1], 2)),  
                  as.character(round(t2_ratio_ifn_il4_subgroup_L$`P-value`[1], 2)),  
                  as.character(round(t2_ratio_il12_il5_subgroup_L$`P-value`[1], 2)),  
                  as.character(round(t2_ratio_ifn_il5_subgroup_L$`P-value`[1], 2)), 
                  as.character(round(t2_ratio_il12_il13_subgroup_L$`P-value`[1], 2)), 
                  as.character(round(t2_ratio_ifn_il13_subgroup_L$`P-value`[1], 2)), 
                  as.character(round(t2_ratio_il12_il17_subgroup_L$`P-value`[1], 2)),  
                  as.character(round(t2_ratio_ifn_il17_subgroup_L$`P-value`[1], 2)),  
                  as.character(round(t2_ratio_il12_il21_subgroup_L$`P-value`[1], 2)), 
                  as.character(round(t2_ratio_ifn_il21_subgroup_L$`P-value`[1], 2)),
                  as.character(round(t2_ratio_pro_il10_subgroup_L$`P-value`[1], 2)),  
                  as.character(round(t2_ratio_th1_il10_subgroup_L$`P-value`[1], 2)),  
                  as.character(round(t2_ratio_th2_il10_subgroup_L$`P-value`[1], 2)),    
                  as.character(round(t2_ratio_th17_il10_subgroup_L$`P-value`[1], 2)), 
                  as.character(round(t2_ratio_th1_th2_subgroup_L$`P-value`[1], 2)),  
                  as.character(round(t2_ratio_th1_th17_subgroup_L$`P-value`[1], 2)))

#male

pvaltbl12m <- c( "P-value" ,  as.character(round(t2_ratio_il1_il10_subgroup_L$`P-value`[2], 2)), 
                 as.character(round(t2_ratio_il6_il10_subgroup_L$`P-value`[2], 2)),  
                 as.character(round(t2_ratio_tnf_il10_subgroup_L$`P-value`[2], 2)), 
                 as.character(round(t2_ratio_il12_il10_subgroup_L$`P-value`[2], 2)), 
                 as.character(round(t2_ratio_ifn_il10_subgroup_L$`P-value`[2], 2)), 
                 as.character(round(t2_ratio_il4_il10_subgroup_L$`P-value`[2], 2)), 
                 as.character(round(t2_ratio_il5_il10_subgroup_L$`P-value`[2], 2)),  
                 as.character(round(t2_ratio_il13_il10_subgroup_L$`P-value`[2], 2)), 
                 as.character(round(t2_ratio_il17_il10_subgroup_L$`P-value`[2], 2)),  
                 as.character(round(t2_ratio_il21_il10_subgroup_L$`P-value`[2], 2)),  
                 as.character(round(t2_ratio_il2_il10_subgroup_L$`P-value`[2], 2)),  
                 as.character(round(t2_ratio_gmc_il10_subgroup_L$`P-value`[2], 2)),  
                 as.character(round(t2_ratio_il12_il4_subgroup_L$`P-value`[2], 2)),  
                 as.character(round(t2_ratio_ifn_il4_subgroup_L$`P-value`[2], 2)),  
                 as.character(round(t2_ratio_il12_il5_subgroup_L$`P-value`[2], 2)),  
                 as.character(round(t2_ratio_ifn_il5_subgroup_L$`P-value`[2], 2)), 
                 as.character(round(t2_ratio_il12_il13_subgroup_L$`P-value`[2], 2)), 
                 as.character(round(t2_ratio_ifn_il13_subgroup_L$`P-value`[2], 2)), 
                 as.character(round(t2_ratio_il12_il17_subgroup_L$`P-value`[2], 2)),  
                 as.character(round(t2_ratio_ifn_il17_subgroup_L$`P-value`[2], 2)),  
                 as.character(round(t2_ratio_il12_il21_subgroup_L$`P-value`[2], 2)), 
                 as.character(round(t2_ratio_ifn_il21_subgroup_L$`P-value`[2], 2)),
                 as.character(round(t2_ratio_pro_il10_subgroup_L$`P-value`[2], 2)),  
                 as.character(round(t2_ratio_th1_il10_subgroup_L$`P-value`[2], 2)),  
                 as.character(round(t2_ratio_th2_il10_subgroup_L$`P-value`[2], 2)),    
                 as.character(round(t2_ratio_th17_il10_subgroup_L$`P-value`[2], 2)), 
                 as.character(round(t2_ratio_th1_th2_subgroup_L$`P-value`[2], 2)),  
                 as.character(round(t2_ratio_th1_th17_subgroup_L$`P-value`[2], 2)))

#P-value for interaction

pinttbl12 <- c( " " ,  as.character(round(t2_ratio_il1_il10_subgroup_L$int_Pval[1], 2)), 
                 as.character(round(t2_ratio_il6_il10_subgroup_L$int_Pval[1], 2)),  
                 as.character(round(t2_ratio_tnf_il10_subgroup_L$int_Pval[1], 2)), 
                 as.character(round(t2_ratio_il12_il10_subgroup_L$int_Pval[1], 2)), 
                 as.character(round(t2_ratio_ifn_il10_subgroup_L$int_Pval[1], 2)), 
                 as.character(round(t2_ratio_il4_il10_subgroup_L$int_Pval[1], 2)), 
                 as.character(round(t2_ratio_il5_il10_subgroup_L$int_Pval[1], 2)),  
                 as.character(round(t2_ratio_il13_il10_subgroup_L$int_Pval[1], 2)), 
                 as.character(round(t2_ratio_il17_il10_subgroup_L$int_Pval[1], 2)),  
                 as.character(round(t2_ratio_il21_il10_subgroup_L$int_Pval[1], 2)),  
                 as.character(round(t2_ratio_il2_il10_subgroup_L$int_Pval[1], 2)),  
                 as.character(round(t2_ratio_gmc_il10_subgroup_L$int_Pval[1], 2)),  
                 as.character(round(t2_ratio_il12_il4_subgroup_L$int_Pval[1], 2)),  
                 as.character(round(t2_ratio_ifn_il4_subgroup_L$int_Pval[1], 2)),  
                 as.character(round(t2_ratio_il12_il5_subgroup_L$int_Pval[1], 2)),  
                 as.character(round(t2_ratio_ifn_il5_subgroup_L$int_Pval[1], 2)), 
                 as.character(round(t2_ratio_il12_il13_subgroup_L$int_Pval[1], 2)), 
                 as.character(round(t2_ratio_ifn_il13_subgroup_L$int_Pval[1], 2)), 
                 as.character(round(t2_ratio_il12_il17_subgroup_L$int_Pval[1], 2)),  
                 as.character(round(t2_ratio_ifn_il17_subgroup_L$int_Pval[1], 2)),  
                 as.character(round(t2_ratio_il12_il21_subgroup_L$int_Pval[1], 2)), 
                 as.character(round(t2_ratio_ifn_il21_subgroup_L$int_Pval[1], 2)),
                 as.character(round(t2_ratio_pro_il10_subgroup_L$int_Pval[1], 2)),  
                 as.character(round(t2_ratio_th1_il10_subgroup_L$int_Pval[1], 2)),  
                 as.character(round(t2_ratio_th2_il10_subgroup_L$int_Pval[1], 2)),    
                 as.character(round(t2_ratio_th17_il10_subgroup_L$int_Pval[1], 2)), 
                 as.character(round(t2_ratio_th1_th2_subgroup_L$int_Pval[1], 2)),  
                 as.character(round(t2_ratio_th1_th17_subgroup_L$int_Pval[1], 2)))
